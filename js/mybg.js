...
function fill_board() {
	$.ajax({url: "bg.php/board/", 
		headers: {"X-Token": me.token},
		success: fill_board_by_data });
}

function reset_board() {
	$.ajax({url: "bg.php/board/", headers: {"X-Token": me.token}, method: 'POST',  success: fill_board_by_data });
	$('#move_div').hide();
...
function login_to_game() {
	...
	$.ajax({url: "bg.php/players/"+p_color, 
			method: 'PUT',
			dataType: "json",
			headers: {"X-Token": me.token},
...
function game_status_update() {
	...
	clearTimeout(timer);
	$.ajax({url: "bg.php/status/", success: update_status,headers: {"X-Token": me.token} });
}
...
function do_move() {
	...
	$.ajax({url: "bg.php/board/piece/"+a[0]+'/'+a[1], 
			method: 'PUT',
			dataType: "json",
			contentType: 'application/json',
